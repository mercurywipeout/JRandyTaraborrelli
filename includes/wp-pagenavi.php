...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-bullsy'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-bullsy'),
		'last_text' => __('Last &raquo;','wp-bullsy'),
		'next_text' => __('&raquo;','wp-bullsy'),
		'prev_text' => __('&laquo;','wp-bullsy'),
		'dotright_text' => __('...','wp-bullsy'),
		'dotleft_text' => __('...','wp-bullsy'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
