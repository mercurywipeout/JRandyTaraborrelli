...
add_action('init','of_options_bullsy_pmc');

if (!function_exists('of_options_bullsy_pmc')) {
function of_options_bullsy_pmc(){
...
//Testing 
$of_options_bullsy_pmc_select = array("one","two","three","four","five"); 
$of_options_bullsy_pmc_radio = array("one" => "One","two" => "Two","three" => "Three","four" => "Four","five" => "Five");
$of_options_bullsy_pmc_homepage_blocks = array( 
	"disabled" => array (
...
$of_options_bullsy_pmc_thumb_align = array("alignleft" => "Left","alignright" => "Right","aligncenter" => "Center"); 

// Image Links to Options
$of_options_bullsy_pmc_image_link_to = array("image" => "The Image","post" => "The Post"); 

// Set the Options Array
global $of_options_bullsy_pmc;
$of_options_bullsy_pmc = array();



$of_options_bullsy_pmc[] = array( "name" => "Home Settings",
					"type" => "heading");
				
$of_options_bullsy_pmc[] = array( "name" => "General settings",
                    "type" => "innerheading");	

$of_options_bullsy_pmc[] = array( "name" => "Allow responsive mode?",
					"desc" => "Check this if you wish to allow responsive mode.",
					"id" => "showresponsive",
					"std" => 1,
					"type" => "checkbox");						
					
$of_options_bullsy_pmc[] = array( "name" => "Portfolio slug",
...
$of_options_bullsy_pmc[] = array( "name" => "Portfolio and post setting for home page",
                    "type" => "innerheading");								
				
				
$of_options_bullsy_pmc[] = array( "name" => "Number of recent portfolio  on home page",
...
$of_options_bullsy_pmc[] = array( "name" => "Number of recent portfolio items display per slide",
...
$of_options_bullsy_pmc[] = array( "name" => "Number of recent post items display per slide",
...
$of_options_bullsy_pmc[] = array( "name" => "Number of recent posts on home page",
...
$of_options_bullsy_pmc[] = array( "name" => "Content Setting",
                    "type" => "heading");
					
			
					
$of_options_bullsy_pmc[] = array( "name" => "Quote for default pages (blog, sigle post, single portfolio)",
                    "type" => "innerheading");	

$of_options_bullsy_pmc[] = array( "name" => "Big quote text ",
					"desc" => "Enter big text for quote bar.",
					"id" => "quote_big",
					"std" => __('CHECK OUR LATEST WORDPRESS THEME THAT IMPLEMENTS PAGE BUILDER','wp-bullsy'),
					"type" => "text"); 	

$of_options_bullsy_pmc[] = array( "name" => "Small quote text ",
					"desc" => "Enter small text for quote bar.",
					"id" => "quote_small",
					"std" => __('- learn how to build Wordpress Themes with ease with a premium Page Builder which allows you to add new Pages in seconds.','wp-bullsy'),
					"type" => "text"); 	

$of_options_bullsy_pmc[] = array( "name" => "Top bar content",
                    "type" => "innerheading");						
					
$of_options_bullsy_pmc[] = array( "name" => "Icon for telephone text (leave empty if you don't need image.)",
...
$of_options_bullsy_pmc[] = array( "name" => "Telephone text",
					"desc" => "Enter Telephone text for top bar.",
					"id" => "top_notification_tel",
					"std" => __('Premiumcoding Telephone','wp-bullsy'),
					"type" => "text"); 			
					
$of_options_bullsy_pmc[] = array( "name" => "Icon for mail text (leave empty if you don't need image.)",
...
$of_options_bullsy_pmc[] = array( "name" => "Mail text",
					"desc" => "Enter Mail text for top bar.",
					"id" => "top_notification_mail",
					"std" => __('Premiumcoding Mail','wp-bullsy'),
					"type" => "text"); 
	



$of_options_bullsy_pmc[] = array( "name" => "Our major brands images",
                    "type" => "innerheading");							


$of_options_bullsy_pmc[] = array( "name" => "Our major brands",
...
$of_options_bullsy_pmc[] = array( "name" => "Custom Logo",
					"desc" => "Upload a logo for your theme, or specify the image address of your online logo. (http://yoursite.com/logo.png)",
					"id" => "logo",
					"std" => "http://bullsy.premiumcoding.com/wp-content/uploads/2012/10/logo.png",
					"type" => "upload");
									
					
$of_options_bullsy_pmc[] = array( "name" => "Custom Favicon",
					"desc" => "Upload a 16px x 16px Png/Gif image that will represent your website's favicon.",
					"id" => "favicon",
					"std" => "http://curvey.premiumcoding.com/wp-content/uploads/2012/05/faviconLogo.png",
					"type" => "upload"); 					
							
 $of_options_bullsy_pmc[] = array( "name" => "Google Analytics",
                    "desc" => "Paste your Google analytics code here.",
                    "id" => "google_analytics",
                    "std" => "/",
                    "type" => "textarea");	   		                                               									
    
$of_options_bullsy_pmc[] = array( "name" => "Styling Options",
					"type" => "heading");

$of_options_bullsy_pmc[] = array( "name" =>  "Main Theme Color ",
					"desc" => "Set the main color for your theme.",
					"id" => "mainColor",
					"std" => "#EEC43D",
					"type" => "color");		
					
$of_options_bullsy_pmc[] = array( "name" =>  "Second Theme Color (for creating gradient)",
					"desc" => "Set the Second Theme Color (for creating gradient).",
					"id" => "gradient_color",
					"std" => "#ffffff",
					"type" => "color");	
					
$of_options_bullsy_pmc[] = array( "name" =>  "Border Color (for making a border around elements with gradient)",
...
$of_options_bullsy_pmc[] = array( "name" =>  "Box Color ",
...
$of_options_bullsy_pmc[] = array( "name" =>  "Shadow Color ",
...
$of_options_bullsy_pmc[] = array( "name" => "Shadow opacity",
...
$of_options_bullsy_pmc[] = array( "name" => "Body background",
                    "type" => "innerheading");
					
$of_options_bullsy_pmc[] = array( "name" =>  "Body Background Color",
					"desc" => "Pick a background color for the theme.",
					"id" => "body_background_color",
					"std" => "#ffffff",
					"type" => "color");

$of_options_bullsy_pmc[] = array( "name" => "Enable Background Image",
					"desc" => "Displays an image not the color selected above",
					"id" => "background_image",
					"std" => 1,
					"type" => "checkbox");
					
$of_options_bullsy_pmc[] = array( "name" => "Background Pattern",
...
$of_options_bullsy_pmc[] = array( "name" => "Background Image Properties",
...
$of_options_bullsy_pmc[] = array( "name" => "Footer background ",
                    "type" => "innerheading");					
					
$of_options_bullsy_pmc[] = array( "name" => "Enable header and footer Background Pattern",
					"desc" => "Enable header and footer Background Image",
					"id" => "background_image_header",
					"std" => 1,
					"type" => "checkbox");
					
$of_options_bullsy_pmc[] = array( "name" =>  "Header and Footer Background Color",
					"desc" => "Header and Footer Background Color.",
					"id" => "header_background_color",
					"std" => "#F4F4F4",
					"type" => "color");
					
$of_options_bullsy_pmc[] = array( "name" => "Background header and footer Pattern",
...
$of_options_bullsy_pmc[] = array( "name" => "Background header and footer Image Properties",
					"desc" => "You can define additional shorthand properties for the background such as no-repeat here. This is for advanced CSS users only.",
					"id" => "header_bg_properties",
					"std" => "repeat 0 0",
					"type" => "text"); 		

$of_options_bullsy_pmc[] = array( "name" => "Custom Style",
                    "type" => "innerheading");				
...
$of_options_bullsy_pmc[] = array( "name" => "Slider options",
                    "type" => "heading");
					
$of_options_bullsy_pmc[] = array( "name" => "iosSlider",
                    "type" => "innerheading");					
...
$of_options_bullsy_pmc[] = array( "name" => "Nivo slider",
                    "type" => "innerheading");					
...
$of_options_bullsy_pmc[] = array( "name" => "Main Settings",
                    "type" => "innerheading");	

$of_options_bullsy_pmc[] = array( "name" => "Background transparency of text holder",
...
$of_options_bullsy_pmc[] = array( "name" => "Nivo Slider Options",
                    "type" => "innerheading");
													
					
$of_options_bullsy_pmc[] = array( "name" => "Slider text color and font size for Nivo slider",
					"desc" => "Font color and size for Content text",
					"id" => "slider_fontSize_colorNivo",
					"std" => array('size' => '24px','color' => '#ffffff'),
					"type" => "sizeColor");		
					
$of_options_bullsy_pmc[] = array( "name" => "Background color of text holder for Nivo slider",
					"desc" => "Set the Background color of text holder.",
					"id" => "slider_backColorNivo",
					"std" => "#1BAACC",
					"type" => "color");							

$of_options_bullsy_pmc[] = array( "name" => "Border color of text holder for Nivo slider",
...
$of_options_bullsy_pmc[] = array( "name" => "Typography",
                    "type" => "heading");
					
$of_options_bullsy_pmc[] = array( "name" => "Body Typography Settings",
...
$of_options_bullsy_pmc[] = array( "name" => "Social Options",
					"type" => "heading");  
					
$of_options_bullsy_pmc[] = array( "name" => "Show Facebook icon",
					"desc" => "Check if you wish to show Facebook icon",
					"id" => "facebook_show",
					"std" => 1,
					"type" => "checkbox");							
					
$of_options_bullsy_pmc[] = array( "name" => "Facebook link",
					"desc" => "Set the link used for your Facebook icon.",
					"id" => "facebook",
					"std" => "http://premiumcoding.com",
					"type" => "text");

$of_options_bullsy_pmc[] = array( "name" => "Show Twitter icon",
					"desc" => "Check if you wish to show Twitter icon",
					"id" => "twitter_show",
					"std" => 1,
					"type" => "checkbox");							

$of_options_bullsy_pmc[] = array( "name" => "Twitter link",
					"desc" => "Set the link used for your Twitter icon.",
					"id" => "twitter",
					"std" => "http://premiumcoding.com",
					"type" => "text");
					
$of_options_bullsy_pmc[] = array( "name" => "Show Pinterest icon",
					"desc" => "Check if you wish to show Pinterest icon",
					"id" => "vimeo_show",
					"std" => 1,
					"type" => "checkbox");							

$of_options_bullsy_pmc[] = array( "name" => "Pinterest link",
					"desc" => "Set the link used for your Pinterest icon.",
					"id" => "vimeo",
					"std" => "http://premiumcoding.com",
					"type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "Show Dribble icon",
					"desc" => "Check if you wish to show Dribble icon",
					"id" => "youtube_show",
					"std" => 1,
					"type" => "checkbox");							

$of_options_bullsy_pmc[] = array( "name" => "Dribble link",
					"desc" => "Set the link used for your Dribble icon.",
					"id" => "youtube",
					"std" => "http://premiumcoding.com",
					"type" => "text");	
					
$of_options_bullsy_pmc[] = array( "name" => "Show Email icon",
...
$of_options_bullsy_pmc[] = array( "name" => " Email link",
...
$of_options_bullsy_pmc[] = array( "name" => "Error page",
					"type" => "heading");      

					
$of_options_bullsy_pmc[] = array( "name" => "404 Error page Title",
                    "desc" => "Set the title of the Error page (404 not found error).",
                    "id" => "errorpagetitle",
                    "std" => __('OOOPS! 404','wp-bullsy'),
                    "type" => "text");	
					
$of_options_bullsy_pmc[] = array( "name" => "404 Error page Sub Title",
...
$of_options_bullsy_pmc[] = array( "name" => "404 Error page Title Content Text",
                    "desc" => "Add a description for your 404 page.",
                    "id" => "errorpage",
                    "std" => __('Sorry, but the page you are looking for has not been found.<br/>Try checking the URL for errors, then hit refresh.</br>Or you can simply click the icon below and go home:)','wp-bullsy'),
                    "type" => "textarea");	   	
					
	
$of_options_bullsy_pmc[] = array( "name" => "Footer Options",
					"type" => "heading");      
		
					
$of_options_bullsy_pmc[] = array( "name" => "Copyright info",
                    "desc" => "Add your Copyright or some other notice.",
                    "id" => "copyright",
                    "std" => __('&copy; 2011 All rights reserved. ','wp-bullsy'),
                    "type" => "textarea");	
...
$of_options_bullsy_pmc[] = array( "name" => "Translation",
					"type" => "heading");   	
									

$of_options_bullsy_pmc[] = array( "name" => "Social icons",
                    "type" => "innerheading");						

				
$of_options_bullsy_pmc[] = array( "name" => "Social icons title in footer",
                    "desc" => "Translation for social icons title in footer.",
                    "id" => "translation_socialtitle",
                    "std" => __('SOCIALIZE WITH US','wp-bullsy'),
                    "type" => "text");	 
					
$of_options_bullsy_pmc[] = array( "name" => "Facebook icon alt text",
                    "desc" => "Translation for Facebook alt text.",
                    "id" => "translation_facebook",
                    "std" => __('Facebook','wp-bullsy'),
                    "type" => "text");	 	

$of_options_bullsy_pmc[] = array( "name" => "Twitter icon alt text",
                    "desc" => "Translation for twitter alt text.",
                    "id" => "translation_twitter",
                    "std" => __('Twitter','wp-bullsy'),
                    "type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Pinterest icon alt text",
                    "desc" => "Translation for Pinterest alt text.",
                    "id" => "translation_vimeo",
                    "std" => __('Pinterest','wp-bullsy'),
                    "type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Dribble icon alt text",
                    "desc" => "Translation for Dribble alt text.",
                    "id" => "translation_dribble",
                    "std" => __('Dribble','wp-bullsy'),
                    "type" => "text");	

/*$of_options_bullsy_pmc[] = array( "name" => "Stumble Upon icon alt text",
                    "desc" => "Translation for Stumble Upon alt text.",
                    "id" => "translation_stumble",
                    "std" => __('Stumble Upon','wp-bullsy'),
                    "type" => "text");		*/				
					

$of_options_bullsy_pmc[] = array( "name" => "Email icon alt text",
                    "desc" => "Translation for email alt text.",
                    "id" => "translation_email",
                    "std" => __('Send us Email','wp-bullsy'),
                    "type" => "text");	

					
							
$of_options_bullsy_pmc[] = array( "name" => "General Translaction",
                    "type" => "innerheading");								
					
					
$of_options_bullsy_pmc[] = array( "name" => "Our latest posts",
                    "desc" => "Translation for Our latest posts text.",
                    "id" => "translation_post",
                    "std" =>  __('Our latest posts','wp-bullsy'),
                    "type" => "text");	
					
$of_options_bullsy_pmc[] = array( "name" => "Enter search",
                    "desc" => "Translation for enter search text in widget.",
                    "id" => "translation_enter_search",
                    "std" =>  __('Enter search...','wp-bullsy'),
                    "type" => "text");						
					
$of_options_bullsy_pmc[] = array( "name" => "Portfolio title on home page.",
                    "desc" => "Translation for portfolio title on home page.",
                    "id" => "translation_port",
                    "std" => __('Recent from Our portfolio','wp-bullsy'), 
                    "type" => "text");							
					
$of_options_bullsy_pmc[] = array( "name" => "Related post",
                    "desc" => "Translation for Related post text.",
                    "id" => "translation_relatedpost",
                    "std" => __('Related post','wp-bullsy'),
                    "type" => "text");						


$of_options_bullsy_pmc[] = array( "name" => "Home page Our major brands",
                    "desc" => "Translation for Home page Our major brands title.",
                    "id" => "translation_advertise_title",
                    "std" => __('Our major brands','wp-bullsy'),
                    "type" => "text");	
					
					
					
$of_options_bullsy_pmc[] = array( "name" => "Read more for blog",
                    "desc" => "Translation for Read more.",
                    "id" => "translation_morelinkblog",
                    "std" => __('Read more about this...','wp-bullsy'),
                    "type" => "text");						
					
$of_options_bullsy_pmc[] = array( "name" => "Read more for portfolio items on front page",                    
					"desc" => "Translation for Read more.",                    
...
$of_options_bullsy_pmc[] = array( "name" => "Portfolio Translaction",
                    "type" => "innerheading");
					

$of_options_bullsy_pmc[] = array( "name" => "Project Description",
					"desc" => "Set Project Description",
					"id" => "port_project_description",
					"std" => __('Project description:','wp-bullsy'),
					"type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "Project details",
					"desc" => "Set Project details",
					"id" => "port_project_details",
					"std" => __('Project details:','wp-bullsy'),
					"type" => "text");						
									
					
$of_options_bullsy_pmc[] = array( "name" => "Project URL",
					"desc" => "Set the Project URL Title",
					"id" => "port_project_url",
					"std" => __('Project URL:','wp-bullsy'),
					"type" => "text");			
					
$of_options_bullsy_pmc[] = array( "name" => "Project designer",
					"desc" => "Set the Project designer Title",
					"id" => "port_project_designer",
					"std" => __('Project designer:','wp-bullsy'),
					"type" => "text");	
					
$of_options_bullsy_pmc[] = array( "name" => "Project Date of completion",
					"desc" => "Set the Project Date of completion Title",
					"id" => "port_project_date",
					"std" => __('Date of completion:','wp-bullsy'),
					"type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Project Client",
					"desc" => "Set the Client Title",
					"id" => "port_project_client",
					"std" => __('Client:','wp-bullsy'),
					"type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "Share the project",
					"desc" => "Set the Share the project Title",
					"id" => "port_project_share",
					"std" => __('Share the <span>project</span>','wp-bullsy'),
					"type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Related project",
					"desc" => "Set the Related projject Title",
					"id" => "port_project_related",
					"std" => __('Related <span>project</span>','wp-bullsy'),
					"type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Show all",
                    "desc" => "Translation for Show all.",
                    "id" => "translation_all",
                    "std" => __('Show all:','wp-bullsy'),
                    "type" => "text");		
					
					
									

$of_options_bullsy_pmc[] = array( "name" => "Blog translation",
                    "type" => "innerheading");

$of_options_bullsy_pmc[] = array( "name" => "Translation for text By",
                    "desc" => "Translation for text By.",
                    "id" => "translation_by",
                    "std" => __('By: ','wp-bullsy'),
                    "type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Leave the comment",
                    "desc" => "Translation for text Leave the comment.",
                    "id" => "translation_leave_comment",
                    "std" => __('Leave the comment ','wp-bullsy'),
                    "type" => "text");
					

$of_options_bullsy_pmc[] = array( "name" => "Share post",
                    "desc" => "Translation for Share  post title.",
                    "id" => "translation_share_post",
                    "std" => __('Share this post','wp-bullsy'),
                    "type" => "text");		
			

					

$of_options_bullsy_pmc[] = array( "name" => "Comment translation",
                    "type" => "innerheading");
					
$of_options_bullsy_pmc[] = array( "name" => "Recent Comments text",
                    "desc" => "Translation for Recent Comments text.",
                    "id" => "translation_recent_comments",
                    "std" => __('Recent Comments','wp-bullsy'),
                    "type" => "text");						

$of_options_bullsy_pmc[] = array( "name" => "Leave a Reply text",
                    "desc" => "Translation for Leave a Reply title.",
                    "id" => "translation_comment_leave_replay",
                    "std" => __('Leave a Reply','wp-bullsy'),
                    "type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Leave a Reply to text",
                    "desc" => "Translation for Leave a Reply to title.",
                    "id" => "translation_comment_leave_replay_to",
                    "std" => __('Leave a Reply to','wp-bullsy'),
                    "type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "Cancle Replay text",
                    "desc" => "Translation for Cancle Replay title.",
                    "id" => "translation_comment_leave_replay_cancle",
                    "std" => __('Cancle Replay','wp-bullsy'),
                    "type" => "text");						

$of_options_bullsy_pmc[] = array( "name" => "Name text",
                    "desc" => "Translation for Name text.",
                    "id" => "translation_comment_name",
                    "std" => __('Name','wp-bullsy'),
                    "type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "Mail text",
                    "desc" => "Translation for Mail text.",
                    "id" => "translation_comment_mail",
                    "std" => __('Mail','wp-bullsy'),
                    "type" => "text");	

$of_options_bullsy_pmc[] = array( "name" => "Website text",
                    "desc" => "Translation for Website text.",
                    "id" => "translation_comment_website",
                    "std" => __('Website','wp-bullsy'),
                    "type" => "text");							

$of_options_bullsy_pmc[] = array( "name" => "Required text",
                    "desc" => "Translation for required text.",
                    "id" => "translation_comment_required",
                    "std" => __('required','wp-bullsy'),
                    "type" => "text");							

$of_options_bullsy_pmc[] = array( "name" => "Comments are closed text",
                    "desc" => "Translation for Comments are closed text.",
                    "id" => "translation_comment_closed",
                    "std" => __('Comments are closed.','wp-bullsy'),
                    "type" => "text");		

$of_options_bullsy_pmc[] = array( "name" => "No Responses text",
                    "desc" => "Translation for No Responses text.",
                    "id" => "translation_comment_no_responce",
                    "std" => __('No Responses','wp-bullsy'),
                    "type" => "text");

$of_options_bullsy_pmc[] = array( "name" => "One Response text",
                    "desc" => "Translation One Response text.",
                    "id" => "translation_comment_one_comment",
                    "std" => __('One Response','wp-bullsy'),
                    "type" => "text");

$of_options_bullsy_pmc[] = array( "name" => "Responses text",
                    "desc" => "Translation for Responses text.",
                    "id" => "translation_comment_max_comment",
                    "std" => __('Responses','wp-bullsy'),
                    "type" => "text");					


		
$of_options_bullsy_pmc[] = array( "name" => "Backup Options",
					"type" => "heading");

$of_options_bullsy_pmc[] = array( "name" => "Backup and Restore Options",
                    "id" => "of_backup",
                    "std" => "",
                    "type" => "backup",
...
$of_options_bullsy_pmc[] = array( "name" => "Transfer Theme Options Data",
                    "id" => "of_transfer",
